...
var columns = [{ width: 100 }, { width: 200 }, { width: 110 }, { width: 140 }, { width: 90 }];

var rows = [{
        height: 40, customHeight: true,
        cells: [{ value: 'Order Summary', colSpan: 5,
        // Applied styles to 'A1' cell through cell property binding
        style: { fontFamily: 'Axettac Demo', verticalAlign: 'middle', textAlign: 'center', fontSize: '18pt', fontWeight: 'bold',
            color: '#279377', border: '1px solid #e0e0e0' }
    }] },
    {
...
var spreadsheet = new ej.spreadsheet.Spreadsheet({
    sheets: sheets,
    // Applied cell formatting to range of cells using 'cellFormat' method once the component is loaded
    created: function () {
        ...
        spreadsheet.cellFormat({ textAlign: 'left', textIndent: '8pt' }, 'B2:B12');
        spreadsheet.cellFormat({ fontStyle: 'italic', textAlign: 'right' }, 'C3:C12');
        spreadsheet.cellFormat({ textAlign: 'left', textIndent: '8pt' }, 'D2:D12');
