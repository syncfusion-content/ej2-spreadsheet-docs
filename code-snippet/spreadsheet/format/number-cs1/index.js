...
var columns = [{ width: 140 }, { width: 140 }, { width: 160 }, { width: 160 }, { width: 160 }, { width: 120 }];
...
},
{
    ...
    { formula: '=SUM(C3:C10)', format: ej.spreadsheet.getFormatFromType('Accounting') },
...
var spreadsheet = new ej.spreadsheet.Spreadsheet({
    sheets: sheets,
    // Applied number formatting to range of cells using 'numberFormat' method once the component is loaded
    created: function () {
        ...
        // Applied Accounting format to cells from c3 to E10 range.
        spreadsheet.numberFormat('_($* #,##0.00_);_($* (#,##0.00);_($* "-"??_);_(@_)', 'C3:E10');
        // Applied Percentage format to cells from c3 to E11 range.
